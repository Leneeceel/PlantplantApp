...
public class UserCart extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txtTotalDisp = findViewById(R.id.txtTotalDisp);
...
//        editor = sharedPreferences.edit();
    ...
    void generateCartItems()
    {
        ...
        txtTotalDisp.setText(String.valueOf(total));
    }

    public void btnPurchase(View v)
    {
        Intent i = new Intent(UserCart.this, Purchase.class);
        startActivity(i);
    }
    public void backToShopping(View v)
    {
        Intent i = new Intent(UserCart.this, Shopping.class);
        startActivity(i);
    }
